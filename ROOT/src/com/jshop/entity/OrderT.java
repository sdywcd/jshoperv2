...
/**
 * OrderT entity. @author MyEclipse Persistence Tools
 */
...
public class OrderT implements java.io.Serializable {
	...
	/** minimal constructor */
	public OrderT(String orderid, String userid, String username, String paymentid, String paymentname, String delivermode, String orderstate, String logisticsid, double freight, double amount, Date purchasetime, String invoice, String shippingaddressid, double shouldpay, double usepoints, String paystate) {
