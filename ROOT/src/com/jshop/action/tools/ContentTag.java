...
//	public static final String SYSTEMCONTENTARTICLECONTENT="文章详细";
//	public static final String ARTICLECONTENTSIGN="articlecontent";
//	
//	public static final String TEMPLATENAMEFORGOODSDETAIL="goodsdetail";
//	public static final String SYSTEMCONTENTGOODSDETAIL="商品详细";
//	public static final String TEMPLATENAMEFORGOODSCATEGORYLIST="goodscategorylist";
//	public static final String SYSTEMCONTENTGOODSCATEGORYLIST="商品分类列表";
...
//	public static final String SYSTEMCONTENTLOGIN="登录";
...
//	public static final String SYSTEMCONTENTUSERACTIVATESCALLBACK="用户激活回调页面";
