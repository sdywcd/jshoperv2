...
<%
	...
	String htmlData = request.getParameter("expressarea") != null
			? request.getParameter("expressarea")
			: "";
%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!-- end footert -->
<script type="text/javascript" src="<%=basePath%>jshop/admin/js/expresstempletesetjs.js"></script>

		<script type="text/javascript">
 		KE.show({
			id : 'expressarea',
			imageUploadJson :'<%=basePath%>jshop/admin/js/jsp/upload_jsonn.jsp',
