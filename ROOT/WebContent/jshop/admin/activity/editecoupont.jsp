...
<body>
	<!-- header 包含头部导航-->
			...
			<div id="right">
				...
				<div class="form">
						...
						<div class="fields">
								...
								<div class="select">
										<select id="ecouponstate" name="ecouponstate" onchange="ons()">
											<option value="0">
												---请选择---
											</option>
											<option value="1">
							...
							<div class="field field-first" id="goods" style="display: none">
								<div class="label">
							...
							<div class="field field-first" id="goodss" style="display: none" >
								<div class="label">
									<label for="input-small">
										商品ID:
									</label>
							...
							<div class="field field-first">
								<div class="input">
									<div class="button highlight">	
										...
										<input type="button" id="update" name="update" value="提交"  />										
									</div>
								</div>
							</div>
						</div>
		...
		<script type="text/javascript" src="<%=basePath%>/jshop/admin/js/editecouponjs.js"></script>
