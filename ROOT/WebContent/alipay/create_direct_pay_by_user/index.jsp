...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.jshop.pay.alipay.alipaydirect.create_direct_pay_by_user.services.*"%>
<%@ page import="com.jshop.pay.alipay.alipaydirect.create_direct_pay_by_user.util.*"%>
...
<dl class="content">
	<dt>标题：</dt>
	<dd><span class="red-star">*</span> <input size=30 name=subject />
	...
	<dd><span class="red-star">*</span> <input maxLength=10 size=30
		...
		value="00.00" /> <span>如：112.21</span></dd>
	<dt>备注：</dt>
