...
public class JshopActivityNGoodsViewPager extends Activity {
	...
	public class GoodsPagerAdapter extends PagerAdapter{
		...
		public Object instantiateItem(View collection, int position) {
			View v;
			LayoutInflater myinflater = (LayoutInflater) collection.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			v = myinflater.inflate(R.layout.jshop_m_forgoodsviewpager, null);
			//ImageView goodsimage = (ImageView) v.findViewById(R.id.goodsimage);
			TextView test = (TextView) v.findViewById(R.id.goodsdetail);
