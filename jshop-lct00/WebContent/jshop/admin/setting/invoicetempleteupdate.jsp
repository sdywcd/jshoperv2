...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath %>jshop/admin/js/invoicetempleteupdatejs.js"></script>
	<style type="text/css">
  ...
  <body>
	 ...
	 <!-- 影藏的发货单编号 -->
	 <input type="hidden" id="hidinvoicetempleteid" name="hidinvoicetempleteid" value=""/>
  </body>
</html>
<%!
