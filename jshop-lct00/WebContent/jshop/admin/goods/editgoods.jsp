...
.abelinked{  
   ...
   clear:both;  
	...
	<body onload="findgoodsbyid();">
								...
								<div class="field field-first">
									...
									<div class="input">
										<div style="display: none;">
											<span id="shownavid"></span>--
											<span id="showltypeid"></span>--
											<span id="showstypeid"></span>
										</div>
		...
		<!-- end footert -->
		<script type="text/javascript" src="<%=basePath%>/jshop/admin/js/editgoodsjs.js"></script>
